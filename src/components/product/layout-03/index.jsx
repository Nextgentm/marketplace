...
const Product = ({ title, slug, price, latestBid, image, authors, bitCount, likeCount, className }) => {
  ...
  return (
    <>
      <div className={clsx("lg-product-wrapper colum-2 two-colum-parent-product col-lg-6", className)}>
        <div className="inner">
          ...
          <Button color="primary-alta" size="medium" className="bid-btn" onClick={handleBidModal}>
            Place a Bid
          </Button>
        </div>
      </div>
