...
const ForumAnswerCard = () => (
  <div className="forum-single-ans">
    ...
    <div className="ans-content">
      <p>
        Check regularly the website, cause I’m in the same situation. They will add more artists sooner or later, check
        also the discord channel they have. But most important, be patient and keep sharing your work in other social
