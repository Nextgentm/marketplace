...
const CommunityCard = ({ thumbnail, title, path, published_at, tags, total_comments, likes, views, excerpt }) => (
  <div className="single-community-box">
    <div className="community-bx-header">
      <div className="header-left">
        {thumbnail?.src && (
          <div className="thumbnail">
            <Image src={thumbnail.src} alt={thumbnail?.alt || "NFT-thumbnail"} width={73} height={73} />
          </div>
        )}
        <div className="name-date">
          ...
          <span className="date">{dayjs().to(dayjs(published_at))}</span>
        </div>
      </div>
    ...
    <div className="community-content">
      ...
      <div className="rn-community-footer">
        ...
        <div className="answer">
          <Button path={path} color="primary-alta" shape="ellipse" size="medium">
            Answer
          </Button>
        </div>
      </div>
