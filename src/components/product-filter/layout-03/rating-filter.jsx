      ...
      <div className="inner">
        ...
        <div className="content">
          <div className="nuron-form-check">
            <input type="checkbox" name="rating" value={5} onChange={handleClick} id="rating-check1" />
          ...
          <div className="nuron-form-check">
            <input type="checkbox" name="rating" value={4} onChange={handleClick} id="rating-check2" />
          ...
          <div className="nuron-form-check">
            <input type="checkbox" name="rating" value={3} onChange={handleClick} id="rating-check3" />
          ...
          <div className="nuron-form-check">
            <input type="checkbox" name="rating" value={2} onChange={handleClick} id="rating-check4" />
          ...
          <div className="nuron-form-check">
            <input type="checkbox" name="rating" value={1} onChange={handleClick} id="rating-check5" />
