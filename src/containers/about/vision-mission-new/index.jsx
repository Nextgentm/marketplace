            ...
            <div className="row g-5 vision-mision-grid">
                <div className="col-12 col-lg-6">
                    <div className="boxStyle">
                        <img src="https://cdn.lootmogul.com/wp-content/uploads/2024/07/31045020/Glyph.png" alt="icon" />
                        <div>
                ...
                <div className="col-12 col-lg-6">
                    <div className="boxStyle">
                        <img src="https://cdn.lootmogul.com/wp-content/uploads/2024/07/31045018/Group-8874.png" alt="icon" />
                        <div>
                ...
                <div className="col-12 col-lg-6">
                    <div className="boxStyle">
                        <img src="https://cdn.lootmogul.com/wp-content/uploads/2024/07/31045022/Group-8872.png" alt="icon" />
                        <div>
                ...
                <div className="col-12 col-lg-6">
                    <div className="boxStyle">
                        <img src="https://cdn.lootmogul.com/wp-content/uploads/2024/07/31045016/Group-8867.png" alt="icon" />
                        <div>
