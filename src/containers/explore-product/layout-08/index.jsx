      ...
      <div className="container">
        ...
        {products.length > 0 && (
          <div className="row g-5">
            {products.map((prod) => (
              <div className="col-5 col-lg-4 col-md-6 col-sm-6 col-12" key={prod.id}>
                <Product
                  overlay
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="view-more-btn mt--50">
              <Button color="primary-alta" className={!hasMore ? "disabled" : ""} fullwidth onClick={loadMoreHandler}>
                {hasMore ? <>View More Items</> : <>No More Items</>}
              </Button>
            </div>
          </div>
        </div>
