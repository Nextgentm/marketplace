...
const ActivityArea = ({ space, className, data }) => {
  ...
  const marketFilters = [...new Set(flatDeep(data?.activities.map((activity) => activity.marketFilters)))];
  const userFilters = [...new Set(flatDeep(data?.activities.map((activity) => activity.userFilters)))];
