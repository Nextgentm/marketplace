      ...
      <div className="row g-5">
        <div className="col-lg-8">
          <div className="community-content-wrapper">
            <Tabs defaultActiveKey="recent-content" id="uncontrolled-tab-example" className="mb--30">
              <Tab eventKey="recent-content" title="Recent Content">
                {forums?.map((forum) => (
                  <CommunityCard
                    key={forum.path}
          ...
          {pagiData.numberOfPages > 1 && (
            <Pagination currentPage={pagiData.currentPage} numberOfPages={pagiData.numberOfPages} rootPage="/forum" />
          )}
        </div>
