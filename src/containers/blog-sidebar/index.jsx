...
const BlogSidebar = ({ className, categories, recentPosts, tags, rootPage }) => (
  <aside className={clsx("rwt-sidebar", className)}>
    {categories?.length > 0 && <CategoryWidget categories={categories} rootPage={rootPage} />}
    {recentPosts?.length > 0 && <RecentPostsWidget recentPosts={recentPosts} rootPage={rootPage} />}
