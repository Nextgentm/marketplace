...
import { ProductType, SectionTitleType, NotifactionType, SellerType } from "@utils/types";
    ...
    <div className="container">
      <div className="row g-5">
        <div className="col-lg-8 custom-product-col">
          {data?.section_title && <h2 className="text-left mb--50">{data.section_title.title}</h2>}
        ...
        <div className="col-lg-4 custom-product-col">
          <div
            ...
            style={{ top: "90px" }}
          >
            <NotificationArea data={{ notifications: data.notifications }} />
