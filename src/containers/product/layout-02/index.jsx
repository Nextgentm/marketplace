    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          {data?.section_title && <h2 className="text-center mb--50">{data.section_title.title}</h2>}
          <TabContainer defaultActiveKey="nav-home">
            ...
            <TabContent>
              <TabPane eventKey="nav-home" className="lg-product_tab-pane lg-product-col-2">
              ...
              <TabPane eventKey="nav-profile" className="lg-product_tab-pane lg-product-col-2">
                {shuffleArray(data?.products)?.map((prod) => (
                  <Product
                    key={prod.id}
                    title={prod.title}
              ...
              <TabPane eventKey="nav-contact" className="lg-product_tab-pane lg-product-col-2">
                {shuffleArray(data?.products)?.map((prod) => (
                  <Product
                    key={prod.id}
                    title={prod.title}
