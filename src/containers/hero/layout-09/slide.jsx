          ...
          <div className="col-lg-7">
            <div className="inner text-left">
              <div className="top-bid-price d-flex">
                <span className="latest-bid mr--15">Highest bid {latestBid}</span>
                      ...
                      <div className="thumbnail">
                        {highest_bid?.user?.image?.src && (
                          <Anchor path={highest_bid.user.path}>
                            <Image src={highest_bid.user.image.src} alt="Nft_Profile" width={44} height={44} />
                          </Anchor>
                        )}
                      </div>
                      <div className="top-seller-content">
                        <span className="heighest-bid">
                          Heighest bid <Anchor path={highest_bid.user.path}>{highest_bid.user.name}</Anchor>
                        </span>
