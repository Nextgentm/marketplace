...
import { HeadingType, TextType, ImageType, ButtonType, ItemType, ProductType } from "@utils/types";

const HeroArea = ({ data: { headings, texts, buttons, badge, items, product } }) => (
      ...
      <div className="row d-flex align-items-center">
        ...
        <div className="col-lg-12 col-xl-6 order-1 order-xl-2">
          <div
            ...
            data-sal-duration="800"
          >
            <div className="single-slide-product" data-sal-delay="700" data-sal="slide-left" data-sal-duration="800">
            ...
            {badge?.image?.src && <BannerBadge02 image={badge.image} />}
          </div>
        </div>
      </div>
    </div>
