  ...
  <div className="nuron-information">
    <div className="profile-form-wrapper">
      <div className="input-two-wrapper mb--15">
        ...
        <div className="last-name half-wid">
          ...
          <input name="contact-name" id="contact-name-last" type="text" value="Sunayra" onChange={(e) => e} />
        </div>
      </div>
    ...
    <div className="input-two-wrapper mt--15">
      ...
      <div className="half-wid phone-number">
        ...
        <input name="contact-name" id="PhoneNumber" type="text" value="+880100000000" onChange={(e) => e} />
      </div>
    </div>
    <div className="input-two-wrapper mt--15">
      <div className="half-wid currency">
      ...
      <div className="half-wid phone-number">
        ...
        <input name="contact-name" id="address" type="text" value="USA Cidni" onChange={(e) => e} />
      </div>
    </div>
