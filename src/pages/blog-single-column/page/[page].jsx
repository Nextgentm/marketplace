...
const BlogSingleColumn = ({ posts, categories, recentPosts, tags, pagiData, page }) => (
  <Wrapper>
    <SEO pageTitle={`Blog Single Column - Page: ${page}`} />
    <Header />
    <main id="main-content">
      <Breadcrumb pageTitle="Blog Single Column" currentPage="Blog Single Column" />
      <div className="rn-blog-area rn-blog-details-default rn-section-gapTop">
        <div className="container">
          <div className="row g-6">
            <div className="col-xl-8 col-lg-8">
              <BlogArea data={{ posts }} rootPage="/blog-single-column" />
            </div>
          ...
          <div className="row">
            <div className="col-lg-8 sal-animate" data-sal="slide-up" data-sal-delay="550" data-sal-duration="800">
...
export async function getStaticProps({ params }) {
  const { page } = params;
  const posts = getAllPosts(["title", "date", "slug", "author", "image", "excerpt", "category", "tags", "timeToRead"]);
