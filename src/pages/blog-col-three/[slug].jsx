        ...
        <div className="container">
          <div className="row g-6">
            <div className="col-xl-8 col-lg-8">
              ...
              <CommentsArea />
              <CommentForm />
              <RelatedPostsArea relatedPosts={relatedPosts} rootPage="/blog-col-three" />
            </div>
            <div className="col-xl-4 col-lg-4 mt_md--40 mt_sm--40">
              <BlogSidebar categories={categories} recentPosts={recentPosts} tags={tags} rootPage="/blog-col-three" />
            </div>
          </div>
        </div>
      </div>
...
export async function getStaticProps({ params }) {
  const { slug } = params;
  const post = getPostBySlug(slug, ["content", "title", "date", "slug", "image", "category"]);
  const posts = getAllPosts(["category", "slug", "title", "tags", "image", "timeToRead"]);
