                  ...
                  <div class="rn-support-read">
                    <div class="read-card">
                      <div class="content">
                        ...
                        <p style={{ color: "#fff", marginBottom: "15px" }}>
                          <b style={{ color: "#e90a63;" }}>Driving the Digital Sports Economy: </b>Our Monetization-First strategy for brands and athletes, coupled with a user-friendly approach to blockchain and AI, offers a sustainable revenue model while enhancing engagement. Whether you're a brand looking to tap into a vibrant sports community, an athlete seeking to connect with fans, or a fan eager for unparalleled access to sports action and merchandise, LootMogul is your ultimate destination.
                        </p>
                        <p style={{ color: "#fff", marginBottom: "15px" }}>
