  ...
  return (
    <Wrapper>
      ...
      <main id="main-content">
        <Breadcrumb pageTitle={router.query.collection ? "Explore Collection" : "Explore NFT"} currentPage={router.query.collection ? "Explore Collection" : "Explore NFT"} isCollection={true} />
        {dataCollectibles && (
          <ExploreProductArea
            data={{
              section_title: {
