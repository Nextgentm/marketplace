        ...
        <div className="container">
          <div className="row g-6">
            <div className="col-xl-8 col-lg-8">
              ...
              <CommentsArea />
              <CommentForm />
              <RelatedPostsArea relatedPosts={relatedPosts} rootPage="/blog-col-two" />
            </div>
            <div className="col-xl-4 col-lg-4 mt_md--40 mt_sm--40">
              <BlogSidebar categories={categories} recentPosts={recentPosts} tags={tags} rootPage="/blog-col-two" />
            </div>
          </div>
        </div>
      </div>
