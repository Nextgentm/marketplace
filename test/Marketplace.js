...
contract("NFTmarketplace", (accounts) => {
  ...
  describe(`NFTmarketplace contract address`, async () => {
    ...
    it(`Trade`, async () => {
      await ERC721Instance.setApprovalForAll(proxyInstance.address, true, { from: accounts[1] }); // approval to transfer from proxy
      const getfee = await tradeInstance.getFees([
        accounts[0],
        accounts[1],
      ...
      const mint = await ERC721Instance.createToken("sample", "10000000000000000", {
        from: accounts[1],
